...
class _AddBusinessScreenState extends State<AddBusinessScreen> {
  ...
  Future<void> _submitBusiness() async {
    ...
    try {
      ...
      final business = Business(
        id: '',
        ownerId: FirebaseService.currentUser?.uid ?? '',
      ...
      final success = await businessProvider.addBusiness(business);

      if (success) {
        _showSnackBar('Business added successfully!', isError: false);
        Navigator.of(context).pop();
      } else {
        _showSnackBar(
          businessProvider.errorMessage ?? 'Failed to add business',
        );
      }
    } catch (e) {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: _isLoading
          ? const widgets.LoadingWidget(message: 'Adding business...')
              ...
              child: Form(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const SizedBox(height: 8),
                    Text(
                      'Fill in the information below to add your business',
      ...
      children: [
        ...
        GestureDetector(
          ...
          child: Container(
            ...
            height: 200,
            decoration: BoxDecoration(
              color: _selectedImage != null ? Colors.black : AppTheme.grey100,
